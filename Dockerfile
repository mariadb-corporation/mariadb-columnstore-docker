...
RUN dnf -y install \
     https://cspkg.s3.amazonaws.com/columnstore-1.5.4-1/custom/608/centos8/MariaDB-shared-10.5.5_3-1.el8.x86_64.rpm \
     https://cspkg.s3.amazonaws.com/columnstore-1.5.4-1/custom/608/centos8/MariaDB-common-10.5.5_3-1.el8.x86_64.rpm \
     https://cspkg.s3.amazonaws.com/columnstore-1.5.4-1/custom/608/centos8/MariaDB-client-10.5.5_3-1.el8.x86_64.rpm \
     https://cspkg.s3.amazonaws.com/columnstore-1.5.4-1/custom/608/centos8/MariaDB-server-10.5.5_3-1.el8.x86_64.rpm \
     https://cspkg.s3.amazonaws.com/columnstore-1.5.4-1/custom/608/centos8/MariaDB-backup-10.5.5_3-1.el8.x86_64.rpm \
     https://cspkg.s3.amazonaws.com/columnstore-1.5.4-1/custom/608/centos8/MariaDB-cracklib-password-check-10.5.5_3-1.el8.x86_64.rpm \
     https://cspkg.s3.amazonaws.com/columnstore-1.5.4-1/custom/608/centos8/MariaDB-columnstore-engine-10.5.5_3-1.el8.x86_64.rpm

# Add, Unpack & Clean CMAPI Package
RUN mkdir -p /opt/cmapi
ADD https://cspkg.s3.amazonaws.com/cmapi/master/253/mariadb-columnstore-cmapi.tar.gz /opt/cmapi
WORKDIR /opt/cmapi
